...
export const questions: QuestionTask[] = [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если на первой картинке мама-медведица, то как назвать того, кто изображен на второй картинке? Нажми на ту картинку, на которой изображен детёныш животного.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если человека, который играет на пианино, называют пианистом, то как называют человека, который играет на гитаре? Нажми на ту картинку, на которой изображен гитара.",
    options: [
  ...
  // Блок 10. Возвратные глаголы
  {
    ...
    type: "click",
    instruction:
      "На картинках человек расчесывает чужие волосы и расчесывается сам. Нажми на ту картинку, где человек расчесывает волосы.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "На картинках человек одевает девочку и одевается сам. Назови и нажми на ту картинку, где человек одевается.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "На картинках человек учит других и учиться сам. Назови и нажмина ту картинку, где человек учиться.",
    options: [
