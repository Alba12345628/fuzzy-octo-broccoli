...
export const questions: QuestionTask[] = [
  ...
  // Блок 2. Уменьшительно-ласкательные (экспрессивная)
  {
    ...
    type: "click",
    instruction:
      "Если это машина, то как назвать маленький предмет? Нажми на правильную картинку.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если это платье, то как назвать маленькое? Нажми на правильную картинку.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если это сумка, то как назвать маленькую? Нажми на правильную картинку.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если это мама-лиса, то как назвать детеныша? Нажми на него.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если это мама-медведица, то как назвать детеныша? Нажми на него.",
    options: [
  ...
  // Блок 4. Вместилища
  {
    ...
    block: 4,
    type: "click",
    instruction: "В чем хранится сахар? Нажми на правильную картинку.",
    options: [
      { id: "opt1", imageSrc: "/images/4-1-sugar-bowl.png" },
      { id: "opt2", imageSrc: "/images/4-2-wrong-1.png" },
    ],
  ...
  },
  {
    ...
    block: 4,
    type: "click",
    instruction: "Назови и нажми на то, в чем хранится масло.",
    options: [
      { id: "opt1", imageSrc: "/images/4-2-butter-dish.png" },
      { id: "opt2", imageSrc: "/images/4-3-wrong-1.png" },
    ],
    correctOptionId: "opt1",
  },
  {
    ...
    block: 4,
    type: "click",
    instruction: "Назови и нажми на то, в чем хранится соль.",
    options: [
      { id: "opt1", imageSrc: "/images/4-3-salt-shaker.png" },
      { id: "opt2", imageSrc: "/images/4-2-wrong-1.png" },
    ],
    correctOptionId: "opt1",
  },
  ...
  // Блок 5. Единичность
  {
    ...
    type: "click",
    instruction:
      "Покажи, где бусы, а где одна бусинка. Нажми на бусинку.",
    options: [
  ...
  },
  {
    ...
    block: 5,
    type: "click",
    instruction: "Из чего состоит снег? Нажми на частичку.",
    options: [
  ...
  },
  {
    ...
    block: 5,
    type: "click",
    instruction: "Нажми на одну горошину.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Как называют человека, который играет на гитаре? Нажми на гитариста.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Как называют человека, который катается на лыжах? Нажми на лыжника.",
    options: [
  ...
  // Блок 7. Мужской и женский род
  {
    ...
    type: "drag-and-drop",
    instruction:
      "Перетащи картинки: в первый столбик — животных мужского рода, во второй — женского.",
    categories: [
    ...
    items: [
      {
        id: "item1",
        imageSrc: "/images/7-1-bear-m.jpg",
        correctCategoryId: "male",
      },
      {
        id: "item2",
        imageSrc: "/images/7-1-bear-f.jpg",
        correctCategoryId: "female",
      },
      {
        id: "item3",
        imageSrc: "/images/7-1-lion-m.jpg",
        correctCategoryId: "male",
      },
      {
        id: "item4",
        imageSrc: "/images/7-1-lion-f.jpg",
        correctCategoryId: "female",
      },
    ],
  },
  ...
  // Блок 8. Глаголы (противоположные)
  {
    ...
    block: 8,
    type: "click",
    instruction: "Нажми на ту картинку, где воду наливают.",
    options: [
      { id: "opt1", imageSrc: "/images/8-1-pour-in.png" },
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Нажми на ту картинку, где человек закрыл дверь.",
    options: [
      { id: "opt1", imageSrc: "/images/8-2-door-open.png" },
  ...
  // Блок 9. Глаголы (вид)
  {
    ...
    block: 9,
    type: "click",
    instruction: "Нажми на ту картинку, где человек рисует.",
    options: [
      { id: "opt1", imageSrc: "/images/9-1-drawing.jpg" },
      { id: "opt2", imageSrc: "/images/9-1-drawn.jpg" },
    ],
    correctOptionId: "opt1",
  },
  {
    ...
    type: "click",
    instruction:
      "Нажми на ту картинку, где человек уже приготовил еду.",
    options: [
  ...
  },
  {
    ...
    block: 9,
    type: "click",
    instruction: "Нажми на ту картинку, где человек строит дом.",
    options: [
      { id: "opt1", imageSrc: "/images/9-3-building.jpg" },
      { id: "opt2", imageSrc: "/images/9-3-built.jpg" },
    ],
    correctOptionId: "opt1",
  },
  ...
  // Блок 10. Возвратные глаголы
  {
    ...
    type: "click",
    instruction:
      "Нажми на ту картинку, где девочка расчесывает чужие волосы.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Нажми на ту картинку, где девочка одевается сама.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Нажми на ту картинку, где мальчик учится сам.",
    options: [
  ...
  // Блок 11. Прилагательные
  {
    ...
    type: "drag-and-drop",
    instruction:
      "Перетащи картинки: в первый столбик – материал (предмет), во второй – то, из чего сделано.",
    categories: [
