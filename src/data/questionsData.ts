...
export const questions: QuestionTask[] = [
  ...
  // Блок 2. Уменьшительно-ласкательные (экспрессивная)
  {
    ...
    type: "click",
    instruction:
      "Если на картинке машина, то как назвать то, что изображено на другой картинке? Нажми на ту картинку, на которой предмет называется «по-маленькому».",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если на картинке платье, то как назвать то, что изображено на другой картинке? Нажми на ту картинку, на которой предмет называется «по-маленькому».",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если на картинке сумка, то как назвать то, что изображено на другой картинке? Нажми на ту картинку, на которой предмет называется «по-маленькому».",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если на картинке мама-лиса, то как назвать того, кто изображен на другой картинке? Нажми на ту картинку, на которой изображен детёныш животного.",
    options: [
  ...
  },
  {
    ...
    type: "click",
    instruction:
      "Если на картинке мама-медведица, то как назвать того, кто изображен на другой картинке? Нажми на ту картинку, на которой изображен детёныш животного.",
    options: [
